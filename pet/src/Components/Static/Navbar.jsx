 ...
 <Button style={{margin:"auto",display:"flex",justifyContent:"center",boxShadow:"1px 1px 3px 1px black", padding:"5px",borderRadius:"10px"}}>Book Now</Button>
  ...
  <div id="about"> 
    ...
    At Tazama Rafiki, we understand that your pets are more than just animals — they're family.
     ...
     or scaly friends. Traditional kennels can often be stressful for pets, <br/>sleaving both you and them feeling uneasy. 
...
Rafiki provides personalized, <br/>home-based pet care services to ensure your
 ...
 is heading off for their own holidays, but we’re here to make sure your pet’s<br/> routine stays intact.
